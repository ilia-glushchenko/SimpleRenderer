...
layout (location = 22, binding = 2) uniform sampler2D uVelocityTextureSampler2D;
layout (location = 23, binding = 3) uniform sampler2D uToneMappingTextureSampler2D;
layout (location = 24, binding = 4) uniform sampler2D uTaaHistoryTextureSampler2D;
layout (location = 25, binding = 5) uniform sampler2D uTaaDrawTextureSampler2D;
layout (location = 26, binding = 6) uniform sampler2D uTaaDebugTextureSampler2D;
...
void main()
{
    ...
    //outColor = mix(texture(uTaaDebugTextureSampler2D, uv), outColor, 0.95);
